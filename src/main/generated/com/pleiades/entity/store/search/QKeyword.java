...
public class QKeyword extends EntityPathBase<Keyword> {
    ...
    private static final long serialVersionUID = -1377637141L;

    public static final QKeyword keyword = new QKeyword("keyword");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final ListPath<ItemKeyword, QItemKeyword> itemKeywords = this.<ItemKeyword, QItemKeyword>createList("itemKeywords", ItemKeyword.class, QItemKeyword.class, PathInits.DIRECT2);
